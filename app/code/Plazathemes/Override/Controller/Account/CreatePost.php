 ...
 */
namespace Plazathemes\Override\Controller\Account;
        ...
        try {
			...
			if(isset($_POST['addressdeault'])){
				...
				$address->setCustomerId($customer->getId())
						...
						->setPostcode($addzip)
						->setCity($addcity)
						->setRegionId($addregion_id)
						->setTelephone($addtelenum)
						->setStreet($addaddress)
